...
return new class extends Migration {
    ...
    {
        foreach (['settings','presentation_events','presentation_sessions','presentation_sections','presentations','follow_ups','leads','product_demo_links','product_media','product_features','products','clients'] as $table) {

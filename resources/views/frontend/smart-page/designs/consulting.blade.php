...
<section class="bg-consulting d-flex align-items-center" style="background: url('{{ asset('smart-templates/consulting/images/consulting/bg.jpg') }}') top;" id="home">
    <div class="container z-1">
        <div class="row">
            <div class="col-md-6 background">
                <div class="title-heading pe-lg-5 pe-md-4">
                    <span class="badge text-bg-primary mb-2">{{ $prospect->industry ?: 'Prepared for you' }}</span>
                    <h1 class="heading fw-bold mb-3 mb-md-5 pb-md-5">{{ $heading }}</h1>
                    <p class="para-desc text-muted pt-md-5">{{ $page->subheading ?: 'A few ideas we put together specifically for your business.' }}</p>

                    @if($ctaSection)
                    <div class="mt-4">
                        <a href="{{ $page->cta_url ?: '#sec-cta' }}" class="btn btn-primary" data-track="cta_clicked" data-section="cta" data-label="Hero CTA">{{ $page->cta_text }}</a>
                    </div>
                    @endif
                </div>
            </div>
            ...
            <div class="col-lg-6 col-md-6">
                <div class="about-left">
                    <div class="position-relative shadow p-2 rounded bg-white-color img-one">
                        <img src="{{ asset('smart-templates/consulting/images/work/about/2.jpg') }}" class="img-fluid rounded" alt="work-image">
                    </div>
                    <div class="img-two shadow rounded-3 overflow-hidden p-2 bg-white-color">
                        <img src="{{ asset('smart-templates/consulting/images/work/about/1.jpg') }}" class="img-fluid rounded-3" alt="work-image">
                    </div>
                </div>
            </div><!--end col-->
...
@if($solutionSection)
<section class="section pt-0" id="sec-solution" data-section="solution">
    <div class="container">
        <div class="row justify-content-center">
    ...
    @if($benefitLines)
    <div class="container mt-100 mt-60 px-0">
        <div class="row g-0 align-items-center">
            @foreach($benefitLines as $i => $benefit)
                <div class="col-lg-3 col-md-6">
                    <div class="card rounded-0 px-4 py-5 bg-primary position-relative overflow-hidden border-0">
                        <span class="h2 text-white">
                            <i class="uil {{ $benefitIcons[$i % count($benefitIcons)] }}"></i>
                        </span>
                        <div class="card-body p-0 content">
                            <h5 class="text-white mb-0">{{ trim($benefit) }}</h5>
                        </div>
                    </div>
                </div><!--end col-->
            @endforeach
        ...
        <div class="row justify-content-center">
            <div class="col-12 text-center">
                <div class="video-solution-cta position-relative" style="z-index: 1;">
                    <div class="position-relative">
                        <img src="{{ asset('smart-templates/consulting/images/cta-bg.jpg') }}" class="img-fluid rounded-md shadow-lg" alt="">
                    </div>
                    <div class="content mt-md-4 pt-md-2">
                        <div class="row justify-content-center">
                            <div class="col-lg-8 text-center">
                                <div class="section-title text-center">
                                    <h4 class="title text-white title-dark mb-4">{{ $ctaSection->title ?: 'Ready when you are' }}</h4>
...
<footer class="footer">
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-4 col-md-6 col-12 mt-4 mt-sm-0 pt-2 pt-sm-0 text-center">

    ...
    <div class="container">
        <div class="row align-items-center">
            ...
            <div class="col-lg-5 col-md-5 order-2 order-md-1 mt-4 pt-2 mt-sm-0 pt-sm-0">
                <img src="{{ asset('smart-templates/agency/images/illustrator/working_with_computer.svg') }}" class="img-fluid" alt="">
            </div>
        </div>
    </div>
</section>
    ...
    <div class="container">
        <div class="row align-items-center">
            <div class="col-lg-6 col-md-6">
                <img src="{{ asset('smart-templates/agency/images/saas/2.png') }}" class="img-fluid" alt="">
            </div>
...
@if($ctaSection)
<section class="section bg-cta" style="background: url('{{ asset('smart-templates/agency/images/1.jpg') }}') center center;" id="sec-cta" data-section="cta">
